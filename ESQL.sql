...
CREATE TABLE VINCOLO_INTEGRITA (
    ...
    FOREIGN KEY(ATTRIBUTO_REFERENTE) REFERENCES ATTRIBUTO(NOME),
    FOREIGN KEY(TABELLA_REFERENTE) REFERENCES TABELLA(NOME),
...
drop procedure VISUALIZZAZIONE_QUESITI_TEST;
DELIMITER $
