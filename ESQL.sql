...
DELIMITER $
CREATE PROCEDURE INSERIMENTO_QUESITO_CODICE(IN TITOLO_TEST VARCHAR(20), IN LIVELLO VARCHAR(20), IN DESCRIZIONE VARCHAR(60))
BEGIN
...
DELIMITER $
CREATE PROCEDURE INSERIMENTO_QUESITO_RISPOSTA_CHIUSA(IN TITOLO_TEST VARCHAR(20), IN LIVELLO VARCHAR(20), IN DESCRIZIONE VARCHAR(60))
BEGIN
...
FOR EACH ROW
BEGIN
	UPDATE QUESITO_RISPOSTA_CHIUSA SET NUM_RISPOSTE = NUM_RISPOSTE + 1 WHERE TITOLO_TEST = NEW.TITOLO_TEST AND ID = NEW.ID_QUESITO;
END//
...
FOR EACH ROW
BEGIN
	UPDATE QUESITO_CODICE SET NUM_RISPOSTE = NUM_RISPOSTE + 1 WHERE TITOLO_TEST = NEW.TITOLO_TEST AND ID = NEW.ID_QUESITO;
END//