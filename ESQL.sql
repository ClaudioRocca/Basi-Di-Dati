...
BEGIN
    ...
    IF num_risposte = 1 THEN
        UPDATE COMPLETAMENTO SET STATO = 'IN_COMPLETAMENTO', DATA_PRIMA_RISPOSTA = DATA, DATA_ULTIMA_RISPOSTA = DATA
...
-- TODO TERMINARE QUESTO TRIGGER E REPLICARE PER QUESITI CODICE
DELIMITER //
...
BEGIN
	...
	select CURDATE() + INTERVAL 4 DAY INTO DATA; 
