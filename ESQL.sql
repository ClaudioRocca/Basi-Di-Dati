...
DELIMITER $
CREATE PROCEDURE INSERIMENTO_OPZIONE(IN TITOLO_TEST VARCHAR(20), IN ID_QUESITO INT, TESTO VARCHAR(50))
BEGIN
	INSERT INTO OPZIONE(ID_OPZIONE, TESTO, ID_QUESITO, TITOLO_TEST) VALUES(0, TESTO, ID_QUESITO, TITOLO_TEST);
...
FOR EACH ROW
BEGIN
	INSERT INTO SEQUENZA_ID_OPZIONI(TITOLO_TEST, ID_QUESITO, ID_OPZIONE) VALUES (NEW.TITOLO_TEST, NEW.ID_QUESITO, 0);
END;
//
