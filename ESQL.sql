...
SELECT CODICE, TITOLO_TEST, COUNT(RISPOSTA_QUESITO_CODICE.ESITO) AS NUMERO_QUESITI_CORRETTI
FROM STUDENTE, RISPOSTA_QUESITO_CODICE
WHERE MAIL =  RISPOSTA_QUESITO_CODICE.MAIL_STUDENTE
GROUP BY CODICE
ORDER BY CODICE DESC;
UNION ALL
SSELECT CODICE, TITOLO_TEST, COUNT(RISPOSTA_QUESITO_CHIUSO.ESITO) AS NUMERO_QUESITI_CORRETTI
FROM STUDENTE, RISPOSTA_QUESITO_CODICE
WHERE MAIL =  RISPOSTA_QUESITO_CODICE.MAIL_STUDENTE
GROUP BY CODICE
ORDER BY CODICE DESC;
