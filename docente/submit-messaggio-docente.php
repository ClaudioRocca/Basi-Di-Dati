...
require_once 'C:/xampp/htdocs/Basi-Di-Dati/vendor/mongodb/mongodb/logger/log_invioMessaggioDocente.php';
...
try {
    ...
    logInvioMessaggioDocente($titoloMessaggio, $testoMessaggio, $testRelativo, $_SESSION["username"]);
